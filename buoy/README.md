...
| ![ (image not found)](images/materials/rope_construction.jpg) | Rope polyester | [TODO length] |  |  | [TODO] | Joins the eyes that lift the buoy with the counterweight, so the used rope must have high tensile and abrasion strengths |
|  | Wire rope clamp |  |  |  | [TODO] |  |
|  | Turnbuckle M8 with eye |  |  |  | [TODO] | The winding direction of either end of turnbuckles is not standardized. They must be matched with the winding direction of the rods |
|  | Threaded rod 1m M8|  |  |  | [TODO] | The winding direction of these rods and the turnbuckles must be matched |
...
The following steps describe an assembly that aims at making the transportation easy and handling during the deployment simple and fast. The float and counterweight can be transported separately, and the weights and fenders must only be added before the deployment. It may be useful to change the order of the steps for other scenarios.

1) Float without fenders [(pictures)](./images/assembly/assembly.md#step-1---float-without-fenders)
...
2) Counterweight frame [(pictures)](./images/assembly/assembly.md#step-2---counterweight-frame)
...
3) Joining float and counterweight [(pictures)](./images/assembly/assembly.md#step-3---joining-float-and-counterweight)
...
4) Mounting an object to the carrier plate [(pictures)](./images/assembly/assembly.md#step-4---mounting-an-object-to-the-carrier-plate)

   * With both the top and bottom of the carrier plate being accessible, the carried object can be tied to the plate with ridgid straps.

5) Adding fenders to the float [(pictures)](./images/assembly/assembly.md#step-5---adding-fenders-to-the-float)
...
6) Adding the weights [(pictures)](./images/assembly/assembly.md#step-6---adding-the-weights)
